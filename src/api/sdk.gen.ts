 ...
 */
export const profile = <ThrowOnError extends boolean = false>(options?: OptionsLegacyParser<unknown, ThrowOnError>) => {
    return (options?.client ?? client).get<ProfileResponse, ProfileError, ThrowOnError>({
        ...options,
        url: '/v1/auth/profile'
    });
};