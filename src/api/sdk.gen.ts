...
import type { GetRecipesData, GetRecipesResponse, CreateRecipeData, CreateRecipeResponse, DeleteRecipeData, GetRecipeData, GetRecipeResponse, UpdateRecipeData, UpdateRecipeResponse, DeleteImageData, UploadImageData, UploadImageResponse, UpdateImageData, UpdateImageResponse, UserLoginData, UserLoginResponse, UserRegisterData, GetProfileData, GetProfileResponse } from './types.gen';
import { zGetRecipesResponse, zCreateRecipeResponse, zGetRecipeResponse, zUpdateRecipeResponse, zUploadImageResponse, zUpdateImageResponse, zUserLoginResponse, zGetProfileResponse } from './zod.gen';
...
export class RecipesService {
    ...
    public static updateImage<ThrowOnError extends boolean = false>(options: Options<UpdateImageData, ThrowOnError>) {
        return (options?.client ?? client).put<UpdateImageResponse, unknown, ThrowOnError>({
            ...
            responseValidator: async (data) => {
                return await zUpdateImageResponse.parseAsync(data);
            },
            url: '/v1/recipes/{id}/image'
        });
    }
